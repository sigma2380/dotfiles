...
write_title "Katies's Settings v1.1"
...
gsettings set org.cinnamon.desktop.background picture-uri "file:///home/public/bunny.jpg"

# Dconf Settings
write_heading "Dconf Settings"
dconf write /org/cinnamon/theme/name "'Mint-Y-Dark-Purple'"
dconf write /org/cinnamon/desktop/interface/cursor-theme "'Bibata-Modern-Classic'"
dconf write /org/cinnamon/desktop/interface/gtk-theme "'Mint-Y-Dark-Purple'"
dconf write /org/cinnamon/desktop/interface/icon-theme "'Mint-Y-Purple'"
dconf write /org/gnome/desktop/interface/gtk-theme "'Mint-Y-Dark-Purple'"
dconf write /org/gnome/desktop/interface/icon-theme "'Mint-Y-Purple'"
