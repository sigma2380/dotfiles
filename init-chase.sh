...
gsettings set org.cinnamon.desktop.background picture-uri "file:///home/public/frogfly.png"

# Dconf Settings
write_section "Dconf Settings"
dconf write /org/cinnamon/theme/name "'Mint-Y-Dark-Green'"
dconf write /org/cinnamon/desktop/interface/cursor-theme "'Bibata-Modern-Classic'"
dconf write /org/cinnamon/desktop/interface/gtk-theme "'Mint-Y-Dark-Green'"
dconf write /org/cinnamon/desktop/interface/icon-theme "'Mint-Y-Green'"
dconf write /org/gnome/desktop/interface/gtk-theme "'Mint-Y-Dark-Green'"
dconf write /org/gnome/desktop/interface/icon-theme "'Mint-Y-Green'"
